...
function ConfirmOrders() {
  ...
  return (
    <div className="admin-product-order-container">
      <h2 className="admin-product-order-title">Confirm Orders</h2>
            ...
            <tbody>
              {paginatedOrders.map((order) => (
                <tr key={order.orderNo}>
                  ...
                  <td><span className="admin-product-order-status-badge status-confirm">{pageStatus}</span></td>
