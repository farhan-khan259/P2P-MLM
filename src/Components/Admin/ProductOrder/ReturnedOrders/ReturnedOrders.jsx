...
function ReturnedOrders() {
  ...
  return (
    <div className="admin-product-order-container">
      <h2 className="admin-product-order-title">Returned Orders</h2>
            ...
            <tbody>
              {paginatedOrders.map((order) => (
                <tr key={order.orderNo}>
                  ...
                  <td><span className="admin-product-order-status-badge status-returned">{pageStatus}</span></td>
                  ...
                  <td className="admin-product-order-action-cell">
                    ...
                    <button type="button" className="admin-product-order-action-btn action-btn-return">Returned</button>
