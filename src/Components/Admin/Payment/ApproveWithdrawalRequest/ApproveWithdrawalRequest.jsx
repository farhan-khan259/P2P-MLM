import './ApproveWithdrawalRequest.css';

const approveWithdrawalRequests = [
  {
    sNo: 1,
...
function ApproveWithdrawalRequest() {
  return (
    <div className="tds-report-page">
      <h2 className="section-title tds-screen-title">Approve Withdrawal Request</h2>
      ...
      <section className="panel tds-panel">
        ...
        <div className="table-wrap tds-table-wrap">
          <table className="data-table tds-table">
            ...
            <tbody>
              {approveWithdrawalRequests.map((row) => (
                <tr key={row.sNo}>
                  <td>{row.sNo}</td>
