...
const allMembersRows = [
  {
    ...
    joiningDateTime: '05-02-2026', jLevel: '21', state: 'BIHAR', city: 'PUNE', status: 'ACTIVE', password: 'ABC@123', wallet: '0.00'
  },
  {
    srNo: '2', sponsorId: 'MM101011', memberId: 'MM101012', name: 'AMBIKA SALUNKE', mobile: '+91 7020110118',
    joiningDateTime: '05-02-2026', jLevel: '9', state: 'BIHAR', city: 'PCMC', status: 'ACTIVE', password: '123456', wallet: '0.00'
  },
  {
    srNo: '3', sponsorId: 'MM101012', memberId: 'MM101013', name: 'AMBIKA SALUNKE', mobile: '+91 7020110118',
    joiningDateTime: '05-02-2026', jLevel: '2', state: 'BIHAR', city: 'PUNE', status: 'IN-ACTIVE', password: '123456', wallet: '0.00'
  },
  {
    srNo: '4', sponsorId: 'MM101013', memberId: 'MM101014', name: 'AMBIKA SALUNKE', mobile: '+91 7020110118',
    joiningDateTime: '05-02-2026', jLevel: '1', state: 'BIHAR', city: 'PATANA', status: 'ACTIVE', password: 'ABCDEF', wallet: '0.00'
  },
  {
    srNo: '5', sponsorId: 'MM101014', memberId: 'MM101015', name: 'AMBIKA SALUNKE', mobile: '+91 7020110118',
    joiningDateTime: '05-02-2026', jLevel: '1', state: 'BIHAR', city: 'THANE', status: 'IN-ACTIVE', password: '123456', wallet: '0.00'
  },
  {
    srNo: '6', sponsorId: 'MM101015', memberId: 'MM101016', name: 'AMBIKA SALUNKE', mobile: '+91 7020110118',
    joiningDateTime: '05-02-2026', jLevel: '2', state: 'BIHAR', city: 'NAGAR', status: 'ACTIVE', password: '123456', wallet: '0.00'
  },
  {
    srNo: '7', sponsorId: 'MM101016', memberId: 'MM101017', name: 'AMBIKA SALUNKE', mobile: '+91 7020110118',
    joiningDateTime: '05-02-2026', jLevel: '1', state: 'BIHAR', city: 'SATARA', status: 'ACTIVE', password: '123456', wallet: '0.00'
  }
];
...
const exportColumns = [
  ...
  'J.Level', 'State', 'City', 'Status', 'Password', 'Wallet'
];
    ...
    <div>
      ...
      <div className="panel" style={{ borderRadius: '28px', padding: '24px' }}>
        ...
        <div className="table-wrap">
          <table className="data-table" style={{ minWidth: '1320px' }}>
            <thead>
              <tr>
                <th>S.no</th>
                <th>SPONSOR ID</th>
